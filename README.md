...
<ol>
  ...
  <li>generate <code>mosquitto.passwd</code> file by running <code>mosquitto_passwd -c mosquitto.passwd <username></code> and copy it into <em>volumes/mosquitto/conf</em></li>
